...
CUSTOM_AGENT_SYSTEM = """\
    ...
    Sau đó, hãy đưa ra tổng đoán về tình trạng sức khỏe tâm thần của người dùng và 1 lời khuyên dễ thực hiện mà người dùng có thể thực hiện ngay tại nhà và sử dụng ứng dụng này thường xuyên hơn để theo dõi sức khỏe tâm thần của mình.
    ...
    Bước 3: Nếu người dùng không muốn tiếp tục cuộc trò chuyện hãy lưu điểm số và thông tin vào file."""
